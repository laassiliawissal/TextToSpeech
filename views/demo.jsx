...
const TEXT_DESCRIPTION = 'La langue du texte doit correspondre à la langue de la voix sélectionnée: La langue de mixage (texte anglais avec voix masculine espagnole) ne produit pas de résultat valide. Le son synthétisé est transmis au client au fur et à mesure de sa production, à l’aide du codage HTTP chunked. L audio est renvoyé au format mp3 et peut être lu à l aide des lecteurs VLC et Audacity.';
